...
public class Dip {
    ...
    private static final int sRANGE = 12;
    private static final int nRANGE = 50;
    ...
    public static Dip generateRandomDip() {
        ...
        for (int i = 0; i < 5; ) {
            int candidate = generator.nextInt(nRANGE);
        ...
        for (int i = 0; i < 2; ) {
            int candidate = generator.nextInt(sRANGE);
...
//criar testes para o set of naturals e adicionar dependencia jacoco