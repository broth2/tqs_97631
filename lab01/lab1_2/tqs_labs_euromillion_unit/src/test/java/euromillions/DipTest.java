...
public class DipTest {
    ...
    public void testConstructorFromBadArrays() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new Dip(new int[]{30, 31, 32}, new int[]{1, 2, 3});
        });
    }
    ...
    @Test
    public void starRange(){
        instance = new Dip(new int[]{10, 20, 30, 40, 50}, new int[]{1, 12});
        String result = instance.format();
        assertEquals("N[ 10 20 30 40 50] S[  1 12]", result, "format as string: formatted string not as expected. ");
    }
